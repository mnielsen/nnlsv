...
interest in rectified linear units (ReLUs, $max(0,x)$, Glorot (2010),
Nair \& Hinton (2010), Jarrett (2009)), a type of artificial neuron
which appears to learn faster than other common types of neuron, such
as sigmoid and tanh units. (Krizhevsky et al. (2012))  Our results
confirm that this is often the case, but, as we shall see, it is also
often much harder to find hyper-parameters so ReLUs learn quickly.  We
are able to provide a compelling visualization demonstrating this, and
...
units (ReLU), and softplus (Glorot (2010), Dugas (2001)).  These
