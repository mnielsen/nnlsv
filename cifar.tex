...
We begin our account with a detailed investigation of how learning
proceeds when we vary two paramaters: the learning rate, and the
momentum coefficient.  These results are of intrinsic interest

1. Learning rate versus friction:

We'll begin with a detailed investigation of learning rate versus
friction.  This enables us to give a concrete and detailed of results.
It also sets the stage for a discussion of the broader question of
which pairs of parameters should we be investigating, etc...

presentation of

Architecture: 20 hidden unit, 40 hidden unit, 40+20 HU.

Activation functions: sigmoid, ReLU, tanh, BReLU.  (A few other
variations: tanh+1, TReLU.)
