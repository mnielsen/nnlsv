...
%
\includegraphics[scale=0.25]{plots/simple/XXX}
%
What these graphs show is the fraction of hyper-parameter choices (in
the learning rate-momentum plane) that achieve a cost below a certain
cost threshold, plotted for several different choices of activation
function.  This quantifies not only how well the network does for the
best choice of hyper-parameter, but also how easy it is to tune.
...
training time.  This video reveals considerable additional richness.
