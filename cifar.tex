...
\includegraphics[scale=1.0]{plots/detailed/LF-20R10R-20T10-CIFAR-3.png}
...
\begin{tabular}{|c|c|c|c|}
        ...
        & & (20-10-softmax) & \\
        \hline
         & 1 epoch & 2 epoches & 3 epoches\\ \hline
sigmoid 
...
\includegraphics[scale=1.0]{plots/detailed/LF-20R10R-20T10-MNIST-6.png}
